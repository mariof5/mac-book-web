...
import {useGLTF, useTexture} from '@react-three/drei' // Changed from useVideoTexture to useTexture
...
export default function MacbookModel(props) {
    ...
    // Use useTexture instead of useVideoTexture for images
    const screenTexture = useTexture(texture)
    ...
    return (
        <group {...props} dispose={null}>
            ...
            <mesh geometry={nodes.Object_123.geometry} rotation={[Math.PI / 2, 0, 0]}>
                <meshBasicMaterial map={screenTexture} /> {/* Using the image texture */}
            </mesh>
